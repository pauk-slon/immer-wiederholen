...
def test_pick_recall_records_last_recall_question() -> None:
...
def test_pick_recall_avoids_repeating_last_recall_question() -> None:
...
def test_pick_recall_repeats_question_when_no_other_variant_is_available() -> None:
    exercise = make_exercise(recalls=True)
    journal = {"last_recall_question": exercise.recalls[0].question}
